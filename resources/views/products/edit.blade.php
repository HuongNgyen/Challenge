...
<body>
    ...
    <label >Name </label>
    <input type="text" class="form-control" placeholder="Enter name" Name="name" value="{{$products->name}}">
  </div>
     <div class="form-group">
    <label >Price </label>
    <input type="text" class="form-control" placeholder="Enter price" Name="price" value="{{$products->price}}">
  </div>
  <div class="form-group">
    <label>Quantity on hand</label>
    <input type="text" class="form-control" placeholder="Enter quantity on hand" Name="quantity" value="{{$products->quantity}}">
  </div>
